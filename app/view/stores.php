                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="blog-wrap mb-40 text-center scroll-zoom">
                                <div class="blog-img mb-25">
                                    <a href="http://localhost/store?brand=<?php echo $brand_name; ?>"><img src="adun/app/backend/media/<?php echo $image; ?>" alt=""></a>
                                </div>
                                <div class="blog-content">
                                    <h3><a href="http://localhost/store?brand=<?php echo $brand_name; ?>"><?php echo $brand_name; ?></a></h3>
                                    <div class="blog-meta blog-mrg-border">
                                        <ul>
                                            <li><a href="http://localhost/store?brand=<?php echo $brand_name; ?>"><?php echo $bio; ?> </a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>

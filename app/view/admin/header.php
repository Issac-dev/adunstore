...
$user_result = $con->query($total_users);
$fetch_user = mysqli_fetch_assoc($user_result);
$total_user = $fetch_user['total_users'];


//Total revenue
$total_revenue = "SELECT SUM(price) AS total_revenues FROM `orders`";
$revenue_result = $con->query($total_revenue);
$fetch_revenue = mysqli_fetch_assoc($revenue_result);
$balance = number_format($fetch_revenue['total_revenues']);
...
foreach ($months as $month) {
    $pJan = "SELECT SUM(price) AS p_sum FROM `orders` WHERE `date` LIKE '%" . $month . "%'";
...
$omonths = array();
foreach ($months as $month) {
    $oJan = "SELECT COUNT(*) AS o_sum FROM `orders` WHERE `date` LIKE '%" . $month . "%'";
...
$prmonths = array();
foreach ($months as $month) {
    $prJan = "SELECT COUNT(*) AS pr_sum FROM `products` WHERE `date` LIKE '%" . $month . "%'";
...
<body class="g-sidenav-show  bg-gray-200">
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link text-white bg-gradient-primary" href="/admin">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white " href="/adblog">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">

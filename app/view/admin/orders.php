                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge badge-dot me-4">
                                <i class="bg-info"></i>
                                <span class="text-dark text-xs">₦<?php echo $price; ?></span>
                            </span>
                        </td>
                        <td>
                            <span class="badge badge-dot me-4">
                                            ...
                                            <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body" style="text-align: left;">
                                                        ...
                                                        <p style="color: black;">Price: ₦<?php echo $price; ?></p>
                                                        ...
                                                        <p style="color: black;">Status: <?php
                                                                                            ...
                                                                                            ?></p>
                                                        <p style="color: black;"><a href="/update?adorders=<?php echo $order_id; ?>"><button style="width: 150pt;" type="button" class="btn btn-block bg-gradient-primary mb-3">Update Status to Paid</button></a></p>
                                                        <p style="color: black;"><a href="/update?adorders=0&delete=<?php echo $order_id; ?>"><button style="width: 150pt;" type="button" class="btn btn-block bg-gradient-primary mb-3">Delete Order</button></a></p>
                                                    </div>
